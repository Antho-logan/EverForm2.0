...
private struct ThemePalette {
  ...
  static let system = ThemePalette(
    backgroundPrimary: dynamicColor(
      light: ThemeColors.backgroundPrimaryLight, dark: ThemeColors.backgroundPrimaryDark),
    backgroundSecondary: dynamicColor(
      light: ThemeColors.backgroundSecondaryLight, dark: ThemeColors.backgroundSecondaryDark),
    cardBackground: dynamicColor(
      light: ThemeColors.cardBackgroundLight, dark: ThemeColors.cardBackgroundDark),
    cardShadow: dynamicShadow(light: ThemeColors.cardShadowLight, dark: ThemeColors.cardShadowDark),
    textPrimary: dynamicColor(
      light: ThemeColors.textPrimaryLight, dark: ThemeColors.textPrimaryDark),
    textSecondary: dynamicColor(
      light: ThemeColors.textSecondaryLight, dark: ThemeColors.textSecondaryDark),
    border: dynamicColor(light: ThemeColors.borderLight, dark: ThemeColors.borderDark),
    beigeBackground: dynamicColor(
      light: ThemeColors.backgroundPrimaryLight, dark: ThemeColors.backgroundPrimaryDark)
  )
